...
RAPIDSMS_TABS = [
    ...
    ("SKD_Release1.apps.SKD_app.views.Message_log",    "Message Log"),   
    ("SKD_Release1.apps.SKD_app.views.State_Report",    "State Report"),
    ("SKD_Release1.apps.SKD_app.views.Locality_Report", "Locality Report"),
    ("SKD_Release1.apps.SKD_app.views.School_Report",   "School Report"),
